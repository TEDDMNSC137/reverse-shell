...
unsigned int scrapPort(char* domainName){
  std::string dataChunk;
    ...
    struct hostent *host;
    // char* hostName = "remotehostsmiley.000webhostapp.com"; //EDIT HOSTNAME HERE
    host = gethostbyname(domainName);
    // host = gethostbyname("remotehostsmiley.000webhostapp.com");
    ...
    // std::cout << "Connected.\n";
    // send(Socket,"GET / HTTP/1.1\r\nHost: remotehostsmiley.000webhostapp.com\r\nConnection: close\r\n\r\n", strlen("GET / HTTP/1.1\r\nHost: remotehostsmiley.000webhostapp.com\r\nConnection: close\r\n\r\n"),0);
